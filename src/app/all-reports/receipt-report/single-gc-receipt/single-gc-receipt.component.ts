...
@Component({
  selector: 'app-single-gc-receipt',
  templateUrl: './single-gc-receipt.component.html',
  styleUrls: ['./single-gc-receipt.component.css']
})
export class SingleGcReceiptComponent implements OnInit {
  gcNumber: any;
  Report: any;
  gcDetails: any;
    total = 0;
